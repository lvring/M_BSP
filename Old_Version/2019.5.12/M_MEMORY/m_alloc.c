...
/**
  ...
  * @brief   内存管理
  * @version V1.0 2019/4/15 -> 修改自https://github.com/thi-ng/tinyalloc
	* @History V1.0 创建
  ******************************************************************************
  */
...
#ifndef TA_BASE
#define TA_BASE 0x20001000 //4*1024*8 使用片内4~24k作为内存管理区域
#endif
...
#ifndef TA_SIZE
#define TA_SIZE 0xB000
#endif

#ifndef TA_HEAP_LIMIT
#define TA_HEAP_LIMIT (TA_BASE + TA_SIZE)
#endif
...
static Block *alloc_block(size_t num) {
    ...
    Block *prev = NULL;
    size_t top  = heap->top;
    num = (num + TA_ALIGN - 1) & (uint32_t)-TA_ALIGN;
    while (ptr != NULL) {
...
bool m_check(void) {
    return TA_HEAP_BLOCKS == m_num_free() + m_num_used() + m_num_fresh();
}
